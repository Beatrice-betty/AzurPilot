...
TEMPLATES = {
    'ap_chart_panel.html': {
        'chart_id', 'panel_title', 'lbl_ap', 'lbl_change', 'lbl_max',
        'lbl_min', 'lbl_mean', 'lbl_ap_series', 'lbl_reset',
        'ap_cur', 'change_color', 'change_sign', 'ap_change', 'ap_max',
        'ap_min', 'ap_avg', 'detail_controls_display',
        'coins_stats_html', 'coins_legend_html',
    },
    'resource_chart.html': {
        'chart_id', 'title', 'stats_html', 'legend_html',
    },
}
