...
export function InstanceActions({instance, current, status, resources, selectedResources, onResourcesChange}: {instance: string; current: string; status: Status; resources: Resource[]; selectedResources: string[]; onResourcesChange: (keys: string[]) => void}) {
