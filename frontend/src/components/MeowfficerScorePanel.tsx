...
import { Cat, ChevronDown, FileText, PawPrint, RefreshCw, Sparkles, TriangleAlert } from 'lucide-react'
import { ApiError, api } from '../api/client'
import type { MeowfficerCat, MeowfficerRubric, MeowfficerScoreReport, MeowfficerTalent } from '../api/types'
...
export function MeowfficerScorePanel({instance}: {instance: string}) {
  ...
  return <section className="panel meow-panel" aria-label={ui('meow.title')}>
    <div className="panel-heading">
